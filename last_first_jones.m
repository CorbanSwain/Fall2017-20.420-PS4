...
k1 = 1;   % [1/M/s] - Activation of V by Xa
k2 = 1;   % [1/M/s] - Activation of V by IIa
k3 = 1;   % [1/M/s] - Activation of VIII by Xa
k4 = 1;   % [1/M/s] - Activation of VIII by IIa (incorrect in paper)
k5 = 1;   % [1/M/s] - Conversion of mIIa to IIa by Va-Xa
k6 = 1;   % [1/M/s] - on-rate for rapidly formed complexes
k7 = 1;   % [1/M/s] - on-rate for the VIIIa-IXa complex
k8 = 1;   % [1/M/s] - on-rate for the Va-Xa complex
k9 = 1;  % [1/s]   - off-rate for VIIIa-Ixa
k10 = 1;  % [1/s]   - off-rate for Va-Xa complex
k11 = 1;  % [1/s]   - Vmax for activation of IX by TF-VIIIa
k12 = 1; % [1/s]   - Vmax for activation of X by TF-VIIIa
k13 = 1;  % [1/s]   - Vmax for activation of X by VIIIa-IXa
k14 = 1;   % [1/s]   - Vmax for mIIa formation by Va-Xa
k15 = 1;  % [1/M/s] - Activation of IX by Xa
k16 = 1;   % [1/s]   - off-rate for IX on TF-VIIa
k17 = 1;   % [1/s]   - off-rate for X on TF-VIIa complex
k18 = 1; % [1/s]   - off-rate for X on VIIIa-IXa complex
k19 = 1;   % [1/s]   - off-rate for II on Va-Xa complex
k20 = 1;  % [1/s]   - constant for the slow degration of VIIIa-IXa
